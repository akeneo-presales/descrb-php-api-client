...
$segmented_image = array(new \OpenAPI\Client\Model\AnyOfFileString()); // AnyOfFileString[] | Segmented Image Files
...
```php
editBrandDescriptionApiV1ProductBrandDescriptionIdPatch($description_id, $brand_description_update): \OpenAPI\Client\Model\BrandDescriptionUpdate
```
...
```php
editDescriptionApiV1ProductDescriptionDescriptionIdPatch($description_id, $product_description_update): \OpenAPI\Client\Model\ProductDescriptionUpdate
```
...
$description_id = 'description_id_example'; // string
$product_description_update = new \OpenAPI\Client\Model\ProductDescriptionUpdate(); // \OpenAPI\Client\Model\ProductDescriptionUpdate
...
------------- | ------------- | ------------- | -------------
 **description_id** | **string**|  |
 **product_description_update** | [**\OpenAPI\Client\Model\ProductDescriptionUpdate**](../Model/ProductDescriptionUpdate.md)|  |

### Return type

[**\OpenAPI\Client\Model\ProductDescriptionUpdate**](../Model/ProductDescriptionUpdate.md)
...
```php
editHistoryDescriptionApiV1ProductHistoryDescriptionIdPatch($description_id, $product_history_update): \OpenAPI\Client\Model\ProductHistoryUpdate
```
...
$description_id = 'description_id_example'; // string
$product_history_update = new \OpenAPI\Client\Model\ProductHistoryUpdate(); // \OpenAPI\Client\Model\ProductHistoryUpdate
...
------------- | ------------- | ------------- | -------------
 **description_id** | **string**|  |
 **product_history_update** | [**\OpenAPI\Client\Model\ProductHistoryUpdate**](../Model/ProductHistoryUpdate.md)|  |

### Return type

[**\OpenAPI\Client\Model\ProductHistoryUpdate**](../Model/ProductHistoryUpdate.md)
...
```php
getDescriptionApiV1ProductDescriptionIdGet($description_id): \OpenAPI\Client\Model\ProductDescriptionExtended
```
...
[**\OpenAPI\Client\Model\ProductDescriptionExtended**](../Model/ProductDescriptionExtended.md)
...
```php
readAllProductDescriptionsApiV1ProductAllGet($score, $name__ilike, $brand_name__ilike, $order_by, $limit, $offset): \OpenAPI\Client\Model\LimitOffsetPageProductDescriptionInDB
```
...
[**\OpenAPI\Client\Model\LimitOffsetPageProductDescriptionInDB**](../Model/LimitOffsetPageProductDescriptionInDB.md)
...
```php
readUserProductDescriptionsApiV1ProductMyReviewsGet($score, $name__ilike, $brand_name__ilike, $order_by, $limit, $offset): \OpenAPI\Client\Model\LimitOffsetPageProductDescriptionInDB
```
...
```php
regenerateBrandDescriptionApiV1ProductRegenerateBrandDescriptionDescriptionIdPost($description_id): \OpenAPI\Client\Model\BrandDescription
```
...
[**\OpenAPI\Client\Model\BrandDescription**](../Model/BrandDescription.md)
...
```php
regenerateDescriptionApiV1ProductRegenerateDescriptionDescriptionIdPost($description_id): \OpenAPI\Client\Model\ProductDescription
```
...
[**\OpenAPI\Client\Model\ProductDescription**](../Model/ProductDescription.md)
...
```php
regenerateHistoryDescriptionApiV1ProductRegenerateHistoryDescriptionDescriptionIdPost($description_id): \OpenAPI\Client\Model\ProductHistory
```
...
[**\OpenAPI\Client\Model\ProductHistory**](../Model/ProductHistory.md)
...
```php
regenerateTechnologyApiV1ProductRegenerateTechnologiesDescriptionDescriptionIdPost($description_id): \OpenAPI\Client\Model\Technologies
```
...
[**\OpenAPI\Client\Model\Technologies**](../Model/Technologies.md)
...
```php
reviewBrandDescriptionApiV1ProductBrandDescriptionIdReviewPost($description_id, $brand_description_update): \OpenAPI\Client\Model\BrandDescriptionUpdate
```
...
```php
reviewDescriptionApiV1ProductDescriptionDescriptionIdReviewPost($description_id, $product_description_update): \OpenAPI\Client\Model\ProductDescriptionUpdate
```
...
```php
reviewHistoryDescriptionApiV1ProductHistoryDescriptionIdReviewPost($description_id, $product_history_update): \OpenAPI\Client\Model\ProductHistoryUpdate
```
