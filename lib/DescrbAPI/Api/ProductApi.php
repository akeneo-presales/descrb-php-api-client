...
class ProductApi
{
     ...
     *
     * @param  string $description_id description_id (required)
     * @param  \AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate $product_description_update product_description_update (required)
     *
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     *
     * @param  string $description_id (required)
     * @param  \AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate $product_description_update (required)
     *
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function editDescriptionApiV1ProductDescriptionDescriptionIdPatchWithHttpInfo($description_id, $product_description_update)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\ProductDescriptionUpdate',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $description_id description_id (required)
     * @param  \AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate $product_history_update product_history_update (required)
     *
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     *
     * @param  string $description_id (required)
     * @param  \AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate $product_history_update (required)
     *
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function editHistoryDescriptionApiV1ProductHistoryDescriptionIdPatchWithHttpInfo($description_id, $product_history_update)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\ProductHistoryUpdate',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\ProductDescriptionExtended|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\ProductDescriptionExtended|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDescriptionApiV1ProductDescriptionIdGetWithHttpInfo($description_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\ProductDescriptionExtended' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\ProductDescriptionExtended', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\ProductDescriptionExtended';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\ProductDescriptionExtended',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\LimitOffsetPageProductDescriptionInDB|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\LimitOffsetPageProductDescriptionInDB|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function readAllProductDescriptionsApiV1ProductAllGetWithHttpInfo($score = null, $name__ilike = null, $brand_name__ilike = null, $order_by = 'score,name,brand_name,created_at,brand_description_bool,product_history_description_bool,technologies_bool', $limit = 50, $offset = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\LimitOffsetPageProductDescriptionInDB' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\LimitOffsetPageProductDescriptionInDB', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\LimitOffsetPageProductDescriptionInDB';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\LimitOffsetPageProductDescriptionInDB',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\BrandDescription|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\BrandDescription|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function regenerateBrandDescriptionApiV1ProductRegenerateBrandDescriptionDescriptionIdPostWithHttpInfo($description_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\BrandDescription' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\BrandDescription', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\BrandDescription';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\BrandDescription',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\ProductDescription|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\ProductDescription|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function regenerateDescriptionApiV1ProductRegenerateDescriptionDescriptionIdPostWithHttpInfo($description_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\ProductDescription' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\ProductDescription', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\ProductDescription';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\ProductDescription',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\ProductHistory|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\ProductHistory|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function regenerateHistoryDescriptionApiV1ProductRegenerateHistoryDescriptionDescriptionIdPostWithHttpInfo($description_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\ProductHistory' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\ProductHistory', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\ProductHistory';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\ProductHistory',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AkeneoPresales\DescrbAPI\Model\Technologies|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError
     */
     ...
     * @throws \AkeneoPresales\DescrbAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AkeneoPresales\DescrbAPI\Model\Technologies|\AkeneoPresales\DescrbAPI\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function regenerateTechnologyApiV1ProductRegenerateTechnologiesDescriptionDescriptionIdPostWithHttpInfo($description_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AkeneoPresales\DescrbAPI\Model\Technologies' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AkeneoPresales\DescrbAPI\Model\Technologies', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AkeneoPresales\DescrbAPI\Model\Technologies';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AkeneoPresales\DescrbAPI\Model\Technologies',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
