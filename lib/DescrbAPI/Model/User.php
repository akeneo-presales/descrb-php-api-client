...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['password'] = $data['password'] ?? false;
        $this->container['totp'] = $data['totp'] ?? false;
        $this->container['trial_ended'] = $data['trial_ended'] ?? null;
    }
    ...
    {
        return $this->container['trial_ended'];
    }

    /**
     * Sets trial_ended
     *
     * @param bool|null $trial_ended trial_ended
     *
     * @return self
     */
    public function setTrialEnded($trial_ended)
    {
        $this->container['trial_ended'] = $trial_ended;
