...
class UserUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['original']) && (mb_strlen($this->container['original']) > 64)) {
            $invalidProperties[] = "invalid value for 'original', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['original']) && (mb_strlen($this->container['original']) < 8)) {
            $invalidProperties[] = "invalid value for 'original', the character length must be bigger than or equal to 8.";
        }
    ...
    {
        if (!is_null($original) && (mb_strlen($original) > 64)) {
            throw new \InvalidArgumentException('invalid length for $original when calling UserUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($original) && (mb_strlen($original) < 8)) {
            throw new \InvalidArgumentException('invalid length for $original when calling UserUpdate., must be bigger than or equal to 8.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($password) && (mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserUpdate., must be bigger than or equal to 8.');
        }
