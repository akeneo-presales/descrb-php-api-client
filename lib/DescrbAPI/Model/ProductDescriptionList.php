...
/**
 * ProductDescriptionList Class Doc Comment
 *
 * @category Class
 * @package  AkeneoPresales\DescrbAPI
 * @author   OpenAPI Generator team
 ...
 */
class ProductDescriptionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductDescriptionList';
    ...
    public function setPhotoUrl($photo_url)
    {
        if (!is_null($photo_url) && (mb_strlen($photo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $photo_url when calling ProductDescriptionList., must be smaller than or equal to 2083.');
        }
        if (!is_null($photo_url) && (mb_strlen($photo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $photo_url when calling ProductDescriptionList., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductDescriptionList., must be smaller than or equal to 1024.');
        }
