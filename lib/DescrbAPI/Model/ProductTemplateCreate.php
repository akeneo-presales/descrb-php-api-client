...
/**
 * ProductTemplateCreate Class Doc Comment
 *
 * @category Class
 * @package  AkeneoPresales\DescrbAPI
 * @author   OpenAPI Generator team
 ...
 */
class ProductTemplateCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductTemplateCreate';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductTemplateCreate., must be smaller than or equal to 1024.');
        }
    ...
    public function setDataLanguage($data_language)
    {
        if (!is_null($data_language) && (mb_strlen($data_language) > 3)) {
            throw new \InvalidArgumentException('invalid length for $data_language when calling ProductTemplateCreate., must be smaller than or equal to 3.');
        }
