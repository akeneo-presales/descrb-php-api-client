 ...
 */
class BodyCreateUserProfileApiV1UsersPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Body_create_user_profile_api_v1_users__post';
