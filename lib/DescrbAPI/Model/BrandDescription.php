...
/**
 * BrandDescription Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BrandDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandDescription';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandDescription., must be smaller than or equal to 1024.');
        }
    ...
    public function setPrompt($prompt)
    {
        if (!is_null($prompt) && (mb_strlen($prompt) > 512)) {
            throw new \InvalidArgumentException('invalid length for $prompt when calling BrandDescription., must be smaller than or equal to 512.');
        }
    ...
    public function setDataLanguage($data_language)
    {
        if (!is_null($data_language) && (mb_strlen($data_language) > 3)) {
            throw new \InvalidArgumentException('invalid length for $data_language when calling BrandDescription., must be smaller than or equal to 3.');
        }
    ...
    public function setPhotoUrl($photo_url)
    {
        if (!is_null($photo_url) && (mb_strlen($photo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $photo_url when calling BrandDescription., must be smaller than or equal to 2083.');
        }
        if (!is_null($photo_url) && (mb_strlen($photo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $photo_url when calling BrandDescription., must be bigger than or equal to 1.');
        }
