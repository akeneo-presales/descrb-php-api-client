...
/**
 * TechnologiesInDB Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TechnologiesInDB implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TechnologiesInDB';
    ...
    protected static $setters = [
        ...
        'technology_list' => 'setTechnologyList'
    ];
    ...
    protected static $getters = [
        ...
        'technology_list' => 'getTechnologyList'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['technology_list'] = $data['technology_list'] ?? null;
    }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TechnologiesInDB., must be smaller than or equal to 1024.');
        }
    ...
    public function setPrompt($prompt)
    {
        if (!is_null($prompt) && (mb_strlen($prompt) > 512)) {
            throw new \InvalidArgumentException('invalid length for $prompt when calling TechnologiesInDB., must be smaller than or equal to 512.');
        }
    ...
    public function setDataLanguage($data_language)
    {
        if (!is_null($data_language) && (mb_strlen($data_language) > 3)) {
            throw new \InvalidArgumentException('invalid length for $data_language when calling TechnologiesInDB., must be smaller than or equal to 3.');
        }
    ...
    /**
     * Gets technology_list
     *
     * @return string[]|null
     */
    public function getTechnologyList()
    {
        return $this->container['technology_list'];
    }

    /**
     * Sets technology_list
     *
     * @param string[]|null $technology_list technology_list
     *
     * @return self
     */
    public function setTechnologyList($technology_list)
    {
        $this->container['technology_list'] = $technology_list;
